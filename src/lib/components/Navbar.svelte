...
<nav class="flex items-center justify-between px-6 py-5 max-w-[1200px] mx-auto w-full">
  <div class="flex items-center gap-2">
    ...
    <span class="font-bold text-xl tracking-tight text-gray-900">Symfon IO</span>
  </div>
  <div class="flex items-center gap-6 text-sm font-medium">
    <a href="#" class="text-gray-500 hover:text-black transition-colors">Log in</a>
    <a href="#" class="bg-[#2563EB] text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors font-semibold">Start orchestrating</a>
  </div>
</nav>
